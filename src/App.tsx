...
const App: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className={`bg-white dark:bg-zinc-900 ${darkMode ? 'dark' : ''}`} style={{ backgroundColor: darkMode ? '#000' : '#F4F2ED', minHeight: '100vh' }}>
            <div className={`container mx-auto p-4`}>
                <h1 className="text-4xl font-bold mb-4 dark:text-zinc-50">Home</h1>
