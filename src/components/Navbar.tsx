...
export default function Navbar({ darkMode, onDarkModeToggle }: NavbarProps) {
    return (
        <>
            ...
            <header
                className="border-b-1 relative z-20 w-full border-b border-slate-200 bg-white shadow-lg
            shadow-slate-700/5 after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px
            after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden
            dark:bg-zinc-900 dark:border-gray-700 transition-colors duration-300"
            >
